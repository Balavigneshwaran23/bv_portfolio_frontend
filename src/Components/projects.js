...
export default function Projects() {
  const projects = [
    {
      title: "Agathiya AI",
      description:
        "Agathiya AI is a cutting-edge platform leveraging HTML, CSS, JavaScript, Node.js, and MongoDB to provide real-time data with seamless AI integration. Designed for efficiency and accuracy, it delivers intuitive, up-to-date insights for an exceptional user experience.",
    ...
    },
    {
      title: "Lexmoon AI",
      description:
        "Lexmoon AI, developed during a stipend-based internship at Lexmoon Private Limited, is a cutting-edge platform for translating legal documents from English to Tamil. Built with HTML, CSS, JavaScript, Node.js, MongoDB, and Python ML (Streamlit), it ensures accuracy and reliability for legal professionals.",
    ...
    },
    {
      title: "Doculang",
      description:
        "DocuLang is a powerful full-stack web application enabling instant, real-time language translation with a responsive interface. Leveraging Node.js and MongoDB, it ensures efficient processing and secure data storage for seamless multilingual communication.",
      src: [Doculang, Doculang2, Doculang3, Doculang4],
      github:
        "https://github.com/BALAVIGNESHWARAN23/doc_language_transulater.git",
  ...
  return (
    <div
      id="projects"
      className=" w-full bg-gradient-to-b from-black to-gray-900 text-white py-10"
    >
      <h2
        data-aos="fade-down-right"
        data-aos-delay="1"
        data-aos-duration="2000"
        className="text-4xl text-center font-bold font-sportyfont text-white mb-6"
      >
      ...
      >
        {projectData.map((project, index) => (
          <div
            data-aos="flip-up"
            data-aos-delay={`${50 + index * 70}`}
            data-aos-duration="2000"
            key={index}
            className={`relative  min-w-fit sm:w-full lg:min-w-[800px] h-fit  sm:h-[300px] md:h-[380px] sm:py-6 md:py-0 border-orange-700 border-[3.5px] mt-6 mb-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer ${
          ...
          >
            ...
            >
              <h3 className="text-lg sm:text-xl mt-2 text-white font-sportyfont">
                &lt;{" "}
                <span className="font-sportyfont text-orange-500">
                  {project.title}
                </span>{" "}
                /&gt;
              </h3>
              <p className="text-sm font-modernfont mt-2">
                {project.description}
              </p>
      ...
      {activeProject && (
        <div className="fixed  inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50">
          <div className="bg-gradient-to-b border-orange-700 border-2 from-gray-900 to-black text-black p-4 rounded-lg w-3/4 max-w-3xl">
            <h3 className="text-xl font-bold font-sportyfont  text-orange-500 mb-4">
