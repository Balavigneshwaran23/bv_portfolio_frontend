        ...
        {about_link[section].map((item, index) => (
                          <li key={index}>
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer" 
                              className=" hover:underline text-2xl font-medium  text-white"
                            >
                              <h3 className=" relative bottom-6 left-8">{item.name}</h3></a>
                          </li>
                                ))}
...
<a href="https://github.com/BALAVIGNESHWARAN23"><FontAwesomeIcon
...
/></a>
<a href="https://www.linkedin.com/in/balavigneshwaran-p-5371b3282"><FontAwesomeIcon
