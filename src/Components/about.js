...
export default function About() {
  const techs = [
    ...
    {
      name: "Javascript",
      img: "https://techstack-generator.vercel.app/js-icon.svg",
    },
    {
      name: "React.js",
    ...
    {
      name: "Flask",
      img: "https://profilinator.rishav.dev/skills-assets/flask.png",
    },
  ...
  return (
    <>
      <div
        id="about"
        className=" bg-gradient-to-b from-black to-gray-900 mt-0 relative text-white px-6 py-16 lg:px-20"
      >
        <div className="flex aboutmin ">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-12 aboutminspace">
            <div className="flex-col">
                      ...
                      <div className="mt-2 space-y-2 text-center">
                        {about_link[section].map((item, index) => (
                          <div
                            ...
                            className="hover:underline text-2xl font-medium text-white cursor-pointer"
                          >
                            <h3 className="relative bottom-6 left-8">
                              {item.name}
                            </h3>
                          </div>
                        ))}
              ...
              <div className="relative bottom-14  text-center ">
                ...
                >
                  <FontAwesomeIcon
                    className="text-orange-700 hover:text-orange-500 text-4xl px-2 z-50  transform relative animate-bounceSmooth transition-transform duration-1000 ease-in-out  hover:animate-hoverSpinScale"
                    icon={faGithub}
                  />
                </a>
                <a
                  ...
                  data-aos-offset="200"
                  data-aos-duration="2000"
                  href="https://www.linkedin.com/in/balavigneshwaran-p-5371b3282"
                >
                  <FontAwesomeIcon
                    className="text-orange-700 hover:text-orange-500 text-4xl px-2 z-50  transform relative animate-bounceSmooth transition-transform duration-1000 ease-in-out  hover:animate-hoverSpinScale"
                    icon={faLinkedin}
                ...
                <a
                  ...
                  data-aos-offset="200"
                  data-aos-duration="2000"
                  href="https://wa.me/919025302745? text=hi ther how can i help you?"
                >
                  <FontAwesomeIcon
                    className="text-orange-700 hover:text-orange-500 text-4xl px-2 z-50  transform relative animate-bounceSmooth transition-transform duration-1000 ease-in-out  hover:animate-hoverSpinScale"
                    icon={faWhatsapp}
          ...
          <div className="absolute  hidden md:block left-10  inset-0 w-1/2 h-full z-9"></div>
          ...
          <div>
            <div
              ...
              data-aos-offset="80"
            >
              <h2 className="text-4xl font-bold mb-4  font-sportyfont">
                &lt; <span className="text-orange-500">About</span> Me /&gt;
              </h2>
              <p className="text-gray-300 leading-relaxed mb-6 font-textfont">
                Hi! I'm{" "}
                <span className="text-orange-500 ">Balavigneshwaran</span>, a
                passionate{" "}
                ...
                <span className="text-orange-500">dynamic </span>and{" "}
                <span className="text-orange-500">
                ...
                <span className="text-orange-500">Tailwind CSS</span>. My goal
                is to help businesses achieve their digital transformation goals
                through robust and scalable web solutions. When I'm not coding,
                you can find me learning{" "}
                <span className="text-orange-500">new tech trends</span> or
                exploring new challenges in the world of{" "}
            ...
            <div>
              <h3
                ...
                data-aos-delay="7"
                data-aos-offset="80"
                className="text-3xl font-bold mb-4 font-sportyfont"
              >
                &lt; My favorite <span className="text-orange-500">tools</span>{" "}
                and <span className="text-orange-500">technologies </span>/&gt;
              </h3>
